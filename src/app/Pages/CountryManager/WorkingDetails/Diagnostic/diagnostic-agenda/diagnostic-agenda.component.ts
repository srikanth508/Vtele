...
@Component({
  selector: 'app-diagnostic-agenda',
  templateUrl: './diagnostic-agenda.component.html',
  styleUrls: ['./diagnostic-agenda.component.css']
})
export class DiagnosticAgendaComponent implements OnInit {
