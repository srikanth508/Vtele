...
@Component({
  selector: 'app-activitity-dashboard-details',
  templateUrl: './activitity-dashboard-details.component.html',
  styleUrls: ['./activitity-dashboard-details.component.css']
})
export class ActivitityDashboardDetailsComponent implements OnInit {
  midwifeid:any;
  languageid:any;
  id:any;
  startdate:any;
 ...
 labels:any;
  ...
  constructor(private SharedService:SharedService,private MidwifeService:MidwifeService,private ActivatedRoute:ActivatedRoute) { }
